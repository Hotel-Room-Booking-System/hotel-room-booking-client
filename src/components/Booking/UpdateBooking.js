...
import { selectBookingById, updateBooking } from "./bookingSlice";
...
const UpdateBooking = () => {
  ...
  const [nrc, setNrc] = useState(booking?.nrc);
  const [phone, setPhone] = useState(booking?.phone);
  const [countryOfOrigin, setCountryOfOrigin] = useState(
    booking?.countryOfOrigin
  );
  const [totalAdults, setTotalAdults] = useState(booking?.totalAdults);
  const [totalChildren, setTotalChildren] = useState(booking?.totalChildren);
      ...
      <div className="container-fluid">
              ...
              <form onSubmit={onSubmit}>
                ...
                <div className="my-3 col-md-6">
                  <label for="guestName" className="form-label">
                    ID
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-3 col-md-6">
                  <label for="nrc" className="form-label">
                    NRC
                  </label>
                  <input
                    class="form-control"
                ...
                <div className="row">
                <div className="mb-3 col-md-6">
                  <label for="Country Of Origin" className="form-label">
                    Country Of Origin
                  </label>
                  <select
                    required
                ...
                <div className="mb-3 col-md-6">
                  <label for="totalAdults" className="form-label">
                    Total Adults
                  </label>
                  <input
                    type="text"
                ...
                <div className="row">
                <div className="mb-3 col-md-6">
                  <label for="totalChildren" className="form-label">
                    Total Children
                  </label>
                  <input
                    type="text"
