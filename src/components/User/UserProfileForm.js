...
import { fetchAllUsers, fetchUser, selectUserById } from "./userSlice"
...
const UserProfileForm = () => {
  ...
  //  getId = user.id;
   ...
   // console.log(info)
    ...
    const canUpdate = [firstname,lastname,username,phone,password,createdAt].every(Boolean) && updateRequestStatus === 'idle'
  ...
  return (
            ...
            <div class="tab-pane fade active show" id="account-general">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control mb-1" value={firstname} onChange={onFirstnameChange}/>
                </div>
                <div class="form-group">
                  <label class="form-label">Last Name</label>
                  <input type="text" class="form-control" value={lastname} onChange={onLastnameChange}/>
                </div>
                <div class="form-group">
                  <label class="form-label">E-mail</label>
                  <input type="text" class="form-control mb-1" value={username} onChange={onUsernameChange} disabled/>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value={createdAt} onChange={onCreatedAtChange} disabled/>
                </div>
            ...
            <div class="tab-pane fade" id="account-change-password">
              <div class="card-body pb-2">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" value={password} onChange={onPasswordChange}/>
                </div>
    ...
    <div class="text-right mt-3">
      <button type="button" class="btn btn-primary" onClick={onFormSubmit} disabled={!canUpdate}>Save changes</button>&nbsp;
      <Link to="/">
